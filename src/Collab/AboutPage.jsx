        ...
        <Fragment>
            ...
            <Box style={{ display:'flex', flexDirection: 'column', justifyContent:'center', alignContent: 'center', marginTop:'0' }}>
                ...
                <Box className='sessionDescription'>
                    ...
                    <h4 style={{ marginTop:'-35px', marginBottom:'12px' }}>About Us:</h4> 
                    ...
                    <h4 style={{ marginTop:'40px', marginBottom:'12px' }}>What are Collaboratives?</h4> 
                    ...
                    <h4 style={{ marginTop:'40px', marginBottom:'12px' }}>Who's Behind rCollabs?</h4>
                    ...
                    <h4 style={{ marginTop:'40px', marginBottom:'12px' }}>Envisioned Impact</h4>
                    ...
                    <h4 style={{ marginTop:'40px', marginBottom:'12px' }}>Join Us</h4>
